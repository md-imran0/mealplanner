    ...
    <div class="recipe-form">
        ...
        <form method="POST" action="{{ route('recipes.store') }}">
            ...
            <div class="field">
                ...
                <input type="number" id="servings" name="servings" min="1" required value="{{ old('servings', 1) }}">
            </div>
            
            <div class="field">
                <label for="prep_time_minutes">Preparation Time (minutes) *</label>
                <input type="number" id="prep_time_minutes" name="prep_time_minutes" min="0" required value="{{ old('prep_time_minutes', 0) }}">
            </div>

            <div class="field">
                <label for="cook_time_minutes">Cooking Time (minutes) *</label>
                <input type="number" id="cook_time_minutes" name="cook_time_minutes" min="0" required value="{{ old('cook_time_minutes', 0) }}">
            </div>
            ...
            <div class="field">
                ...
                <textarea id="instructions" name="instructions" placeholder="Enter step-by-step instructions..." required>{{ old('instructions') }}</textarea>
            </div>
            ...
            <div id="ingredients-container">
                <div class="ingredient-row">
                    ...
                    <div>
                        ...
                        <input type="number" name="amounts[]" step="0.1" min="0.1" placeholder="0" class="amount-input" required>
                    </div>
                </div>
            </div>
